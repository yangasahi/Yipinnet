  ...
  <body background="images/left_bg.gif">
    ...
    <font color="#FFFFFF">
      ...
      <div style="display: block" id="child2">
       ...
       <img src="images/jian.gif"/>
       &nbsp;&nbsp;
       <a href="GoodsServlet?flag=add" target="mainFrame">增加商品</a>
       <br>
       &nbsp;&nbsp;
       <img src="images/jian.gif"/>
       &nbsp;&nbsp;
       ...
       <img src="images/jian.gif"/>
       &nbsp;&nbsp;
       <a href="YipinServlet?flag=tianjia" target="mainFrame">增加TOP100</a>
       <br>
       &nbsp;&nbsp;
       <img src="images/jian.gif">
       &nbsp;&nbsp;
       <a href="ScanServlet?flag=scan" target="mainFrame">扫描商品信息</a>
      </div>
      <br/>
    ...
    <font color="#FFFFFF">
      ...
      <div style="display: block" id="child1">
         ...
         <img src="images/jian.gif">
         &nbsp;&nbsp;
         <a href="FaceServlet?flag=view" target="mainFrame">目录管理</a>
         <br>
         &nbsp;&nbsp;
         <img src="images/jian.gif"/>
         &nbsp;&nbsp;
         <a href="FaceServlet?flag=recomm_view" target="mainFrame">推荐商品管理</a>
      </div>
      <br/>
