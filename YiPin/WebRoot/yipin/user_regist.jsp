				...
				<form name="registform" method="post" action="UserServlet?flag=save" id="registform">
					...
					<div style="width: 982px; border: solid 1px #ccc; margin-top: 8px;">
								...
								<tr>
									<td>
										...
										<div id="PanelReg">
											...
											<div
												style="background-color: #FFF8DD; width: 600px; border: 1px solid #F0CC88; padding: 4px; line-height: 20px; text-align: center; margin-top: 10px;">
												现在注册可以赠送50个积分
											</div>
											<div
												style="padding: 6px 0px; margin: 20px 0px; font-size: 14px;">
												<table cellpadding="6">
													<tbody>
														<tr>
														...
														<tr>
															<td></td>
															<td align="left">
																<input type="submit" name="btnReg" value="注册用户"
																	onclick="checkall()" id="btnReg">
															</td>
														</tr>
													</tbody>
												</table>
						...
						<div style="margin-bottom: 10px;">
							<img src="./会员注册 - 慢慢买_files/lc2.jpg" alt="慢慢买正品行货省钱流程">
						</div>
